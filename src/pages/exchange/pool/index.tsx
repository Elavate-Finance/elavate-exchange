import { ChainId, CurrencyAmount, Currency, JSBI, NATIVE, Pair } from '../../../sushiswap/sdk'
    ...
    <>
      ...
      <Container maxWidth="2xl" className="space-y-6">
        ...
        <Alert
          ...
          message={i18n._(t`Liquidity providers earn a 0.3% fee on all trades proportional to their share of
