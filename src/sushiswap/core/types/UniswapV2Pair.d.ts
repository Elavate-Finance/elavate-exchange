...
export class UniswapV2Pair extends Contract {
  ...
  functions: {
    ...
    initialize(_token0: string, _token1: string, overrides?: Overrides): Promise<ContractTransaction>

    'initialize(address,address)'(_token0: string, _token1: string, overrides?: Overrides): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    'initialize(address,address)'(_token0: string, _token1: string, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    initialize(_token0: string, _token1: string, overrides?: Overrides): Promise<BigNumber>

    'initialize(address,address)'(_token0: string, _token1: string, overrides?: Overrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    initialize(_token0: string, _token1: string, overrides?: Overrides): Promise<PopulatedTransaction>
