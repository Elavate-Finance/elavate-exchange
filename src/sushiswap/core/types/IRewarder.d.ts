...
interface IRewarderInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'onSushiReward', values: [BigNumberish, string, BigNumberish]): string
...
export class IRewarder extends Contract {
  ...
  callStatic: {
    onSushiReward(pid: BigNumberish, user: string, sushiAmount: BigNumberish, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    onSushiReward(pid: BigNumberish, user: string, sushiAmount: BigNumberish, overrides?: Overrides): Promise<BigNumber>
    ...
    pendingTokens(pid: BigNumberish, user: string, sushiAmount: BigNumberish, overrides?: Overrides): Promise<BigNumber>
