...
export class IUniswapV2Pair extends Contract {
  ...
  functions: {
    ...
    'burn(address)'(to: string, overrides?: Overrides): Promise<ContractTransaction>
    ...
    initialize(arg0: string, arg1: string, overrides?: Overrides): Promise<ContractTransaction>

    'initialize(address,address)'(arg0: string, arg1: string, overrides?: Overrides): Promise<ContractTransaction>
    ...
    'skim(address)'(to: string, overrides?: Overrides): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    'initialize(address,address)'(arg0: string, arg1: string, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    initialize(arg0: string, arg1: string, overrides?: Overrides): Promise<BigNumber>

    'initialize(address,address)'(arg0: string, arg1: string, overrides?: Overrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    'burn(address)'(to: string, overrides?: Overrides): Promise<PopulatedTransaction>
    ...
    initialize(arg0: string, arg1: string, overrides?: Overrides): Promise<PopulatedTransaction>

    'initialize(address,address)'(arg0: string, arg1: string, overrides?: Overrides): Promise<PopulatedTransaction>
    ...
    'skim(address)'(to: string, overrides?: Overrides): Promise<PopulatedTransaction>
