...
export class IUniswapV2Factory extends Contract {
  ...
  functions: {
    ...
    'allPairs(uint256)'(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string] & { pair: string }>
    ...
    'setFeeTo(address)'(arg0: string, overrides?: Overrides): Promise<ContractTransaction>

    setFeeToSetter(arg0: string, overrides?: Overrides): Promise<ContractTransaction>

    'setFeeToSetter(address)'(arg0: string, overrides?: Overrides): Promise<ContractTransaction>

    setMigrator(arg0: string, overrides?: Overrides): Promise<ContractTransaction>

    'setMigrator(address)'(arg0: string, overrides?: Overrides): Promise<ContractTransaction>
  }
  ...
  'getPair(address,address)'(tokenA: string, tokenB: string, overrides?: CallOverrides): Promise<string>
  ...
  callStatic: {
    ...
    'setFeeToSetter(address)'(arg0: string, overrides?: CallOverrides): Promise<void>

    setMigrator(arg0: string, overrides?: CallOverrides): Promise<void>

    'setMigrator(address)'(arg0: string, overrides?: CallOverrides): Promise<void>
  }
  ...
  estimateGas: {
    ...
    'getPair(address,address)'(tokenA: string, tokenB: string, overrides?: CallOverrides): Promise<BigNumber>
    ...
    'setFeeTo(address)'(arg0: string, overrides?: Overrides): Promise<BigNumber>

    setFeeToSetter(arg0: string, overrides?: Overrides): Promise<BigNumber>

    'setFeeToSetter(address)'(arg0: string, overrides?: Overrides): Promise<BigNumber>

    setMigrator(arg0: string, overrides?: Overrides): Promise<BigNumber>

    'setMigrator(address)'(arg0: string, overrides?: Overrides): Promise<BigNumber>
  }
  ...
  populateTransaction: {
    ...
    'getPair(address,address)'(tokenA: string, tokenB: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    migrator(overrides?: CallOverrides): Promise<PopulatedTransaction>

    'migrator()'(overrides?: CallOverrides): Promise<PopulatedTransaction>

    setFeeTo(arg0: string, overrides?: Overrides): Promise<PopulatedTransaction>

    'setFeeTo(address)'(arg0: string, overrides?: Overrides): Promise<PopulatedTransaction>

    setFeeToSetter(arg0: string, overrides?: Overrides): Promise<PopulatedTransaction>

    'setFeeToSetter(address)'(arg0: string, overrides?: Overrides): Promise<PopulatedTransaction>

    setMigrator(arg0: string, overrides?: Overrides): Promise<PopulatedTransaction>

    'setMigrator(address)'(arg0: string, overrides?: Overrides): Promise<PopulatedTransaction>
  }
}
