...
interface TimelockInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'admin_initialized', values?: undefined): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'admin_initialized', data: BytesLike): Result
...
export class Timelock extends Contract {
  ...
  functions: {
    ...
    'setPendingAdmin(address)'(pendingAdmin_: string, overrides?: Overrides): Promise<ContractTransaction>
  }
  ...
  populateTransaction: {
    ...
    'setPendingAdmin(address)'(pendingAdmin_: string, overrides?: Overrides): Promise<PopulatedTransaction>
  }
}
