...
interface MigratorInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'desiredLiquidity', values?: undefined): string
  encodeFunctionData(functionFragment: 'factory', values?: undefined): string
  encodeFunctionData(functionFragment: 'migrate', values: [string]): string
  encodeFunctionData(functionFragment: 'notBeforeBlock', values?: undefined): string
  encodeFunctionData(functionFragment: 'oldFactory', values?: undefined): string

  decodeFunctionResult(functionFragment: 'chef', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'desiredLiquidity', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'factory', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'migrate', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'notBeforeBlock', data: BytesLike): Result
...
export class Migrator extends Contract {
  ...
  functions: {
    ...
    'migrate(address)'(orig: string, overrides?: Overrides): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    'migrate(address)'(orig: string, overrides?: CallOverrides): Promise<string>
  ...
  populateTransaction: {
    ...
    'migrate(address)'(orig: string, overrides?: Overrides): Promise<PopulatedTransaction>
